...
<div class="container py-5">
    ...
    <form action="{{ route('books.store') }}" method="POST" class="bg-light p-5 rounded">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('authors') is-invalid @enderror" id="authors" name="authors" value="{{ old('authors', '') }}" required maxlength="255">
            @error('authors')
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="released_at" name="released_at" value="{{ old('released_at', '') }}" required>
            @error('released_at')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="pages" name="pages" value="{{ old('pages') }}" required min="1">
            @error('pages')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="isbn" name="isbn" value="{{ old('isbn', '') }}" required pattern="^(?=(?:\D*\d){10}(?:(?:\D*\d){3})?$)[\d-]+$">
            @error('isbn')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="in_stock" name="in_stock" value="{{ old('in_stock') }}" required min="0">
            @error('in_stock')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
